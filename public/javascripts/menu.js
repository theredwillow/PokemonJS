...
var MenuDisplay = function() {
    ...
    this.chooseSelection = function(e) {
        var selected = (e.type == "click") ? e.target.innerText : thisMenu.selected;
        var selectedIndex = thisMenu.options.indexOf(selected);
        thisMenu.selected = thisMenu.options[selectedIndex];
    ...
    this.draw = function(parentEl) {
        ...
        for (var i = 0; i < thisMenu.options.length; i++) {
            ...
            thisOptionElement.addEventListener("click", thisMenu.chooseSelection);
